...
def add_indicators(data):
    ...
    macd, macd_signal, macd_diff = calculate_macd(data['close'])
    data['macd'] = macd
    data['macd_signal'] = macd_signal
    data['macd_diff'] = macd_diff
    bollinger_hband, bollinger_mavg, bollinger_lband = calculate_bbands(data['close'])
    data['bollinger_hband'] = bollinger_hband
    data['bollinger_mavg'] = bollinger_mavg
    data['bollinger_lband'] = bollinger_lband
